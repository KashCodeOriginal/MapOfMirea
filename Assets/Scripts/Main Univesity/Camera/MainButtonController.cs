...
public class MainButtonController : MonoBehaviour
{
  ...
  public void OnFirstButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'А'");
    }
    else
    {
      OnButtonsClean();
      _isFirstButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'А'");
    }
  }
  public void OnSecondButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'Б'");
    }
    else
    {
      OnButtonsClean();
      _isSecondButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'Б'");
    }
  }
  public void OnThirdButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'В'");
    }
    else
    {
      OnButtonsClean();
      _isThirdButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'В'");
    }
  }
  public void OnFourthButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'Г'");
    }
    else
    {
      OnButtonsClean();
      _isFourthButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'Г'");
    }
  }
  public void OnFifthButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'Д'");
    }
    else
    {
      OnButtonsClean();
      _isFifthButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'Д'");
    }
  }
  public void OnSixthButtonClick()
  {
    ...
    {
      OnButtonsClean();
      OnButtonDisabledColorChanging("Button 'И'");
    }
    else
    {
      OnButtonsClean();
      _isSixthButtonActivated = true;
      OnButtonEnabledColorChanging("Button 'И'");
    }
  }
  private void OnButtonsClean()
  {
    ...
    GameObject.Find("Button 'А'").GetComponent<Image>().color = new Color(1, 1, 1);
    GameObject.Find("Button 'Б'").GetComponent<Image>().color = new Color(1, 1, 1);
    GameObject.Find("Button 'В'").GetComponent<Image>().color = new Color(1, 1, 1);
    GameObject.Find("Button 'Г'").GetComponent<Image>().color = new Color(1, 1, 1);
    GameObject.Find("Button 'Д'").GetComponent<Image>().color = new Color(1, 1, 1);
    GameObject.Find("Button 'И'").GetComponent<Image>().color = new Color(1, 1, 1);
  }
